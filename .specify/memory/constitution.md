...
| 95 | Pipeline Workflow | All `*WorkflowDelegate.kt` steps | Go | IN PROGRESS — minimum implemented: create/get/stream/advance/cancel (097-download-pipeline-integration); remaining steps (transcript, clips, upload) TODO | IN PROGRESS — ActiveStepArea routes states; StepUrl done; StepExecute/StepMode still stub |
