...
This project is indexed by GitNexus as **AutoCut** (2541 symbols, 5512 relationships, 193 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/AutoCut/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/AutoCut/context` | Codebase overview, check index freshness |
| `gitnexus://repo/AutoCut/clusters` | All functional areas |
| `gitnexus://repo/AutoCut/processes` | All execution flows |
| `gitnexus://repo/AutoCut/process/{name}` | Step-by-step execution trace |
